...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Airport Cafe, Barbershop, Convenience Store, Lounge">
    <meta name="description" content="">
    <title>Food Service</title>
    <link rel="stylesheet" href="{{ asset("css/nicepage.css") }}" media="screen">
    <link rel="stylesheet" href="{{ asset("css/Food-Service.css") }}" media="screen">
  ...
  <body data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header" id="sec-b1a5" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><div class="u-clearfix u-sheet u-valign-top-md u-valign-top-sm u-valign-top-xs u-sheet-1">
    ...
    <section class="u-carousel u-slide u-block-4480-1" id="carousel-6a68" data-interval="5000" data-u-ride="carousel">
      <ol class="u-absolute-hcenter u-carousel-indicators u-block-4480-2">
        <li data-u-target="#carousel-6a68" class="u-active u-grey-30" data-u-slide-to="0"></li>
        <li data-u-target="#carousel-6a68" class="u-grey-30" data-u-slide-to="1"></li>
        <li data-u-target="#carousel-6a68" class="u-grey-30" data-u-slide-to="2"></li>
        <li data-u-target="#carousel-6a68" class="u-grey-30" data-u-slide-to="3"></li>
      </ol>
      ...
      <a class="u-carousel-control u-carousel-control-prev u-text-grey-30 u-block-4480-3" href="{{ url("#carousel-6a68") }}" role="button" data-u-slide="prev">
      ...
      <a class="u-carousel-control u-carousel-control-next u-text-grey-30 u-block-4480-4" href="{{ url("#carousel-6a68") }}" role="button" data-u-slide="next">
        <span aria-hidden="true">
