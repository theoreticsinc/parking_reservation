  ...
  <img class="custom-expanded u-image u-image-contain u-image-default u-image-1" src="{{ asset('images/Screenshot2023-12-171142241.png') }}" alt="" data-image-width="1524" data-image-height="600">
        ...
        <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
          <div class="menu-collapse" style="font-size: 1rem; letter-spacing: 0px; font-weight: 500;">
            <a class="u-button-style u-custom-active-color u-custom-border u-custom-border-color u-custom-hover-color u-custom-left-right-menu-spacing u-custom-text-active-color u-custom-text-color u-custom-text-hover-color u-custom-top-bottom-menu-spacing u-nav-link" href="{{ url("{{ url(") }}"#") }}">
          ...
          <div class="u-custom-menu u-nav-container-collapse">
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-inner-container-layout u-sidenav-overflow">
                ...
                <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-3"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{ url("{{ url(") }}"Home.html") }}">Home</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{ url("{{ url(") }}"Parking.html") }}">Parking</a><div class="u-nav-popup"><ul class="u-h-spacing-12 u-nav u-unstyled u-v-spacing-20"><li class="u-nav-item"><a class="u-button-style u-hover-custom-color-1 u-nav-link u-text-hover-white" href="{{ url("{{ url(") }}"#") }}">Shuttle Service</a>
</li></ul>
</div>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{ url("{{ url(") }}"Vehicle-Repair.html") }}">Vehicle Repair</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{ url("{{ url(") }}"Food-Service.html") }}">Food Service</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{ url("{{ url(") }}"Advertising-Opportunities.html") }}">Advertising Opportunities</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{ url("{{ url(") }}"Career-Opportunities.html") }}">Career Opportunities</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{ url("{{ url(") }}"FAQS.html") }}">FAQs</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{ url("{{ url(") }}"Contact.html") }}">Contact us</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{ url("{{ url(") }}"About-Us.html") }}">About Us</a>
</li></ul>
              </div>
            </div>
    ...
    <span class="u-file-icon u-icon u-text-custom-color-8 u-icon-1">
        <img src="{{ asset('/images/522561-536386c5.png') }}" alt="Your Alt Text">
    </span>
</div>
    ...
    <span class="u-file-icon u-icon u-text-custom-color-8 u-icon-2">
        <img src="{{ asset('/images/476700-f6b181d6.png') }}" alt="Your Alt Text">
    </span>
    ...
    <span class="u-file-icon u-icon u-text-custom-color-8 u-icon-3">
        <img src="{{ asset('/images/2376100-126d14f7.png') }}" alt="Your Alt Text">
    </span>
    ...
    <span class="u-file-icon u-icon u-text-custom-color-8 u-icon-4">
        <img src="{{ asset('/images/3131333-ac2faaa1.png') }}" alt="Your Alt Text">
    </span>
            ...
            <div class="u-layout-row">
              <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1">
                  ...
                  <p class="u-align-justify u-text u-text-2"> Ready to take the next step in your career? Please send your resume and cover letter to [Email Address]. Be sure to include the job title in the subject line. We look forward to reviewing your application!</p>
                </div>
              </div>
      ...
      <div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-xl u-sheet-1">
        <div class="custom-expanded u-border-1 u-border-grey-25 u-container-style u-expanded-width-lg u-expanded-width-md u-group u-white u-group-1" data-animation-name="customAnimationIn" data-animation-duration="1250">
          <div class="u-container-layout u-container-layout-1">
            ...
            <a href="{{ url('mailto:contact@yourmail.com') }}" class="u-active-none u-btn u-button-style u-hover-none u-none u-text-hover-palette-1-base u-btn-2">
    <span class="u-file-icon u-icon u-text-custom-color-2">
        <img src="{{ asset('/path/to/your/image.png') }}" alt="Your Alt Text">
    </span>
</a>
            ...
            <div class="u-form u-form-1">
              <form action="https://forms.nicepagesrv.com/v2/form/process" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" style="padding: 0px;" source="email" name="form-2">
                ...
                <div class="u-form-group u-form-submit">
                  <a href="{{ url("{{ url(") }}"#") }}" class="u-btn u-btn-submit u-button-style u-palette-2-base u-btn-3">Submit</a>
            ...
            <div class="u-align-left u-social-icons u-spacing-20 u-social-icons-1">
              <a class="u-social-url" target="_blank" href="https://www.facebook.com/" title="facebook"><span class="u-icon u-icon-circle u-social-facebook u-social-icon u-text-palette-2-base u-icon-4">
              ...
              <a class="u-social-url" target="_blank" href="https://twitter.com/" title="twitter"><span class="u-icon u-icon-circle u-social-icon u-social-twitter u-text-palette-2-base u-icon-5">
              ...
              <a class="u-social-url" target="_blank" href="https://www.instagram.com" title="instagram"><span class="u-icon u-icon-circle u-social-icon u-social-instagram u-text-palette-2-base u-icon-6">
              ...
              <a class="u-social-url" target="_blank" href="https://linkedin.com" title="linkedin"><span class="u-icon u-icon-circle u-social-icon u-social-linkedin u-text-palette-2-base u-icon-7">
              ...
              <a class="u-social-url" target="_blank" href="https://pinterest.com/" title="pinterest"><span class="u-icon u-icon-circle u-social-icon u-social-pinterest u-text-palette-2-base u-icon-8">
