...
<table>
    ...
    <tr>
    <tr>
    <td>Regular Oil 15w-40 (7 Liters)</td>
    <td>₱3,100.00</td>
    <td class="third-column">
    <button id="9" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
    </td>
</tr>
    </tr>
    <tr>
        <td>Regular Oil 15w-40 (8 Liters)</td>
        <td>₱3,400.00</td>
        <td class="third-column">
        <button id="10" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
    </td>
    </tr>
    <tr>
        <td>Regular Oil 15w-40 (9 Liters)</td>
        <td>₱3,700.00</td>
        <td class="third-column">
        <button id="11" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
    </td>
    </tr>
    <tr>
        <td>Regular Oil 15w-40 (7 Liters) with Flushing</td>
        <td>₱4,160.00</td>
        <td class="third-column">
        <button id="15" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
    </td>
    </tr>
    <tr>
        <td>Regular Oil 15w-40 (8 Liters) with Flushing</td>
        <td>₱4,460.00</td>
        <td class="third-column">
        <button id="16" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
    </td>
    </tr>
    <tr>
        <td>Regular Oil 15w-40 (9 Liters) with Flushing</td>
        <td>₱4,760.00</td>
        <td class="third-column">
        <button id="17" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
    </td>
    </tr>
    ...
    <tr>
        <td>Fully Synthetic 5w-40 (7 Liters)</td>
        <td>₱5,900.00</td>
        <td class="third-column">
        <button id="12" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
    </td>
    </tr>
    <tr>
        <td>Fully Synthetic 5w-40 (8 Liters)</td>
        <td>₱6,600.00</td>
        <td class="third-column">
        <button id="13" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
    </td>
    </tr>
    <tr>
        <td>Fully Synthetic 5w-40 (9 Liters)</td>
        <td>₱7,300.00</td>
        <td class="third-column">
        <button id="14" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
    </td>
    </tr>
    <tr>
        <td>Fully Synthetic 5w-40 (7 Liters) with Flushing</td>
        <td>₱6,960.00</td>
        <td class="third-column">
        <button id="18" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
    </td>
    </tr>
    <tr>
        <td>Fully Synthetic 5w-40 (8 Liters) with Flushing</td>
        <td>₱7,660.00</td>
        <td class="third-column">
        <button id="20" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
    </td>
    </tr>
    <tr>
        <td>Fully Synthetic 5w-40 (9 Liters) with Flushing</td>
        <td>₱8,360.00</td>
        <td class="third-column">
        <button id="21" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
    </td>
    </tr>
...
<td colspan="3" style="text-align: center; font-weight: bold; font-size: 20px;">Cleaning Package</td>
    ...
    <tr>
        ...
        <td>₱350.00</td>
        <td class="third-column">
        <button id="67" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
        </td>
    </tr>
    <tr>
        <td>Vacuum</td>
        <td>₱280.00</td>
        <td class="third-column">
        <button id="68" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>₱490.00</td>
        <td class="third-column">
        <button id="69" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
        </td>
    </tr>
    <tr>
        ...
        <td>₱420.00</td>
        <td class="third-column">
        <button id="70" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
        </td>
    </tr>
    <tr>
        ...
        <td>₱1,150.00</td>
        <td class="third-column">
        <button id="71" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
        </td>
    </tr>
    <tr>
        ...
        <td>₱1,800.00</td>
        <td class="third-column">
        <button id="72" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
        </td>
    </tr>
    <tr>
        ...
        <td>₱5,950.00</td>
        <td class="third-column">
        <button id="73" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
        </td>
    </tr>
    <td>Interior Detailing</td>
        <td>₱3,590.00</td>
        <td class="third-column">
        <button id="74" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
        </td>
    </tr>
    <tr>
        ...
        <td>₱9,550.00</td>
        <td class="third-column">
        <button id="75" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
        </td>
    </tr>
    <tr>
        ...
        <td>₱1,350.00</td>
        <td class="third-column">
        <button id="76" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
        </td>
    </tr>
    <tr>
...
<td colspan="3" style="text-align: center; font-weight: bold; font-size: 20px;">Maintenance and Repair</td>
    ...
    <tr>
        ...
        <td>₱2,100.00</td>
        <td class="third-column">
        <button id="77" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
        </td>
    </tr>
    <tr>
        ...
        <td>₱325.00</td>
        <td class="third-column">
        <button id="78" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>₱470.00</td>
        <td class="third-column">
        <button id="79" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
        </td>
    </tr>
    <tr>
        ...
        <td>₱470.00</td>
        <td class="third-column">
        <button id="80" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
        </td>
    </tr>
    <tr>
        ...
        <td>₱2,100.00</td>
        <td class="third-column">
        <button id="81" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
        </td>
    </tr>
    <tr>
        ...
        <td>₱800.00</td>
        <td class="third-column">
        <button id="82" onclick="addToCart(this)" class="add-to-cart-button">&#x1F6D2;</button>
        </td>
