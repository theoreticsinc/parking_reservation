    ...
    <section class="skrollable u-clearfix u-image u-parallax u-section-1" id="sec-645a" data-image-width="4704" data-image-height="3136">
      <div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-sheet-1">
        ...
        <p class="u-custom-font u-text u-text-white u-text-3" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-direction="">Park 'N Fly is the first of its kind and only service in the Philippines wherein customers can leave their vehicles on a daily, weekly or monthly basis either for short-term or long-term parking at very reasonable rates. </p>
            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-3">
                    <div class="form-group">
                      <p class="u-custom-font u-text u-text-custom-color-2 u-text-2" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-direction="">Check-in Time</p>
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="form-group">
                      <p class="u-custom-font u-text u-text-custom-color-2 u-text-2" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-direction="">CheckOUT Time</p>
            ...
            <a href="{{ url("#") }}" class="u-border-1 u-border-custom-color-2 u-border-hover-black u-btn u-button-style u-hover-feature u-none u-text-custom-color-2 u-text-hover-grey-90 u-btn-1" data-animation-name="customAnimationIn" data-animation-duration="1750">book now</a>
        </form>
      </div>
