                    ...
                    <div class="footer-widget">
                        ...
                        <ul class="footer-list-contact">
                            <li>
                                ...
                                <a href="https://maps.app.goo.gl/7fHnWPx82fTWyQgw8">Mia Road Corner Domestic Road Airport,  Pasay City</a>
                            </li>
                            <li>
                                <i class='bx bx-phone-call'></i>
                                <a href="tel:(+63)918-991-0000">(+63)918-991-0000</a>
                            </li>
                            <li>
                                <i class='bx bx-envelope'></i>
                                <a href="mailto:customer_care@parknfly.com.ph">customer_care@parknfly.com.ph</a>
                            </li>
                        </ul>
                    </div>
                </div>
